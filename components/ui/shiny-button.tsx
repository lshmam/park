    ...
    >
      ...
      <span
        style={{
          ...
          backgroundImage:
            "linear-gradient(-75deg,transparent calc(var(--x) + 10%),var(--primary) calc(var(--x) + 25%),transparent calc(var(--x) + 100%))",
        }}
        className="absolute inset-0 z-10 block rounded-[inherit] p-px mix-blend-overlay"
      />
    </motion.button>
  )
})
