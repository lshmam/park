                        ...
                        <div className="grid items-center gap-8 md:grid-cols-2">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="mt-4 max-w-md text-lg text-slate-600">
                                    Aptly is currently in beta. Join the waitlist to be among the first to experience the platform and
                                    provide valuable insights.
                                </p>
                                <Button
                                    className="mt-6 gap-2 bg-yellow-400 px-6 py-6 text-base font-semibold text-slate-900 hover:bg-yellow-500"
